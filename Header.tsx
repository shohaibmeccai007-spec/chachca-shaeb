      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="md:hidden">
            <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="text-gray-700 hover:text-blue-600 transition-colors" aria-label="Toggle navigation">
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-gray-100">
              ...
              <Link to="/book-demo" className="block btn-primary mt-4 text-center" onClick={() => setIsMenuOpen(false)}>
                Book a Demo
              </Link>
            </div>
          </div>
