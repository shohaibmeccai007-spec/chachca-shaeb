...
import { AlertCircle, Link2, BarChart3, ArrowRight, Zap, Gauge, LineChart, CheckCircle2, X, TrendingUp, CornerDownRight, Quote, Star } from 'lucide-react';
  ...
  <section className="max-w-6xl mx-auto px-4 pt-24 pb-20">
      ...
      <div className="bg-gradient-to-r from-fuchsia-50 via-violet-50 to-cyan-50 rounded-2xl p-8 mb-14 flex flex-col items-center shadow-sm relative overflow-hidden border-l-8 border-fuchsia-400">
        ...
        <div className="relative z-10 flex flex-col items-center">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="bg-gradient-to-r from-fuchsia-600 via-violet-600 to-cyan-500 bg-clip-text text-transparent text-lg font-semibold uppercase tracking-wider">The Real Problem</span>
          </div>
          <p className="text-2xl md:text-3xl text-gray-900 font-semibold text-center max-w-3xl mb-2">Marketing teams waste millions because data is scattered across 10+ platforms. You're making big decisions with incomplete information, optimizing for clicks instead of profit.</p>
        </div>
      </div>
    </ScrollReveal>
    {/* Solution Steps */}
    <ScrollReveal variant="fade">
      <div className="flex flex-col md:flex-row gap-8 items-center justify-center mb-16 w-full">
        ...
        <div className="flex-1 min-w-[220px] bg-white rounded-2xl p-6 text-center shadow-md border-t-8 border-fuchsia-400">
          ...
          <div className="text-lg text-gray-800 mb-1">Connect all data sources in minutes</div>
        </div>
        {/* Step 2 */}
        <div className="flex-1 min-w-[220px] bg-white rounded-2xl p-6 text-center shadow-md border-t-8 border-violet-400">
          ...
          <div className="text-lg text-gray-800 mb-1">AI builds your profit-first dashboard</div>
        </div>
        {/* Step 3 */}
        <div className="flex-1 min-w-[220px] bg-white rounded-2xl p-6 text-center shadow-md border-t-8 border-cyan-400">
          ...
          <div className="text-lg text-gray-800 mb-1">Autonomous optimization + clear ROI</div>
        </div>
      </div>
    </ScrollReveal>
    {/* Before/After Cards */}
    <ScrollReveal>
      <div className="flex flex-col md:flex-row gap-7 items-center justify-center mb-12">
        ...
        <div className="flex-1 bg-gradient-to-r from-fuchsia-50 to-violet-50 border-l-8 border-fuchsia-400 p-7 rounded-2xl shadow-inner min-w-[260px]">
          <div className="flex items-center gap-2 mb-2 text-fuchsia-600 font-bold uppercase text-sm"><X className="w-5 h-5" /> Before</div>
        ...
        <div className="flex-1 bg-gradient-to-r from-violet-50 to-cyan-50 border-l-8 border-cyan-400 p-7 rounded-2xl shadow-inner min-w-[260px]">
          <div className="flex items-center gap-2 mb-2 text-cyan-600 font-bold uppercase text-sm"><CheckCircle2 className="w-5 h-5" /> After</div>
          <ul className="list-disc text-gray-700 pl-6 text-base space-y-1">
    ...
    <ScrollReveal variant="fade">
      <div className="flex flex-col items-center pt-6">
        <Link to="/book-demo" className="inline-flex items-center px-7 py-4 bg-gradient-to-r from-fuchsia-500 via-violet-500 to-cyan-400 rounded-full text-lg font-extrabold text-white shadow-xl hover:scale-[1.04] transition-all">
  ...
  const testimonials = [
    {
      ...
      testimonial: "Flable AI transformed our marketing operations completely. We saw a 120% increase in conversion rates within the first month. The AI CMO approach is revolutionary.",
      rating: 5,
    ...
    },
    {
      ...
      testimonial: "The autonomous optimization features saved us 20+ hours per week. Our ROAS improved by 340% and we're now scaling profitably across all channels.",
      rating: 5,
    ...
    },
    {
      ...
      testimonial: "Flable AI's profit-first approach changed everything. We finally have clarity on which campaigns actually drive revenue, not just vanity metrics.",
      rating: 5,
        ...
        <ScrollReveal>
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-fuchsia-200 rounded-full px-6 py-3 mb-8">
              ...
              <span className="text-sm font-medium text-gray-700">Customer Success Stories</span>
            </div>
            <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
              <span className="bg-gradient-to-r from-fuchsia-500 via-cyan-400 to-violet-500 bg-clip-text text-transparent">What Our Clients Say</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Real results from real businesses using Flable AI to transform their marketing operations
            </p>
          </div>
        </ScrollReveal>
          ...
          <div className="text-center mt-16">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20 max-w-2xl mx-auto">
              <h3 className="text-3xl font-bold text-gray-900 mb-4">
                <span className="bg-gradient-to-r from-fuchsia-500 via-cyan-400 to-violet-500 bg-clip-text text-transparent">Ready to Join Them?</span>
              </h3>
              <p className="text-gray-600 mb-6 text-lg">
                Start your transformation with Flable AI and see results in 7 days
              </p>
              <Link to="/book-demo" className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-fuchsia-500 via-cyan-400 to-violet-500 rounded-full text-white font-bold text-lg shadow-xl hover:scale-105 transition-all duration-300">
