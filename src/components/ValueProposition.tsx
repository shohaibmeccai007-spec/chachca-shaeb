...
const ValueProposition = () => {
  const benefits = [
    ...
    },
    {
      ...
      stat: "80% less analysis & reporting time",
        ...
        <ScrollReveal>
          <div className="text-center mb-20">
            <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
              <span className="brand-text">Why Marketers Love Us</span>
            </h2>
            <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Flable acts as your{" "}
              <span className="font-bold brand-text">AI CMO </span>, bringing
              clarity, intelligence, and accountability to every marketing
              dollar.
          ...
          {benefits.map((benefit, index) => (
            <ScrollReveal key={index} variant="zoom">
              ...
              >
                ...
                <div
                  className={`relative w-16 h-16 rounded-2xl ${benefit.color
                    .replace("border-", "bg-")
                    .replace("text-", "text-")
                    .replace(
                      "bg-",
                ...
                <div className="text-center relative z-10">
                  ...
                  <div
                    className={`inline-block px-4 py-2 rounded-full text-sm font-bold ${benefit.color
                      .replace("border-", "bg-")
                      .replace("50", "100")}`}
                  >
                    {benefit.stat}
                ...
                <div className="absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <ArrowRight
                    className={`h-5 w-5 ${benefit.color.split(" ")[1]}`}
                  />
                </div>
              </div>
            </ScrollReveal>
