          ...
          {benefits.map((benefit, index) => (
            ...
            >
              ...
              <div className="absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <ArrowRight className={`h-5 w-5 ${benefit.color.split(' ')[1]}`} aria-hidden="true" />
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-20 text-center">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-8 md:p-12">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Join businesses already using AI to boost their marketing performance
            </p>
            <Link to="/book-demo" className="inline-flex items-center gap-2 bg-white text-blue-600 px-8 py-4 rounded-xl text-lg font-bold hover:bg-gray-50 transition-colors transform hover:scale-105 duration-200 shadow-lg">
