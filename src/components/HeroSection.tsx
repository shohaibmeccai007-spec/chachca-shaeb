        ...
        <div className="mb-16">
            <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-indigo-200 rounded-full px-6 py-3 mb-8">
              ...
              <h1 className="text-7xl md:text-8xl font-bold mb-8 leading-tight">
                ...
                <br />
                <span className="text-gray-900">Your Chief Marketing Officer</span>
              </h1>

              <p className="text-2xl md:text-3xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-12 font-light">
                The world's first AI-powered Chief Marketing Officer that thinks, strategizes, and executes like a seasoned marketing executive—but never sleeps, never takes vacation, and always delivers results.
              </p>
              ...
              <div className="group">
                    <div className="relative overflow-hidden rounded-2xl">
                      <img
                        ...
                        alt="AI CMO Command Center"
                        className="w-full h-64 object-cover group-hover:scale-105 transition-transform duration-700"
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent"></div>
                      <div className="absolute bottom-4 left-4 text-white">
                        <div className="text-sm font-semibold">AI CMO Command Center</div>
                        <div className="text-xs opacity-90">Real-time marketing intelligence</div>
                      </div>
                    </div>
                  </div>
                  <div className="group">
                    <div className="relative overflow-hidden rounded-2xl">
                      <img
                        ...
                        alt="AI CMO Analytics"
                        className="w-full h-64 object-cover group-hover:scale-105 transition-transform duration-700"
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent"></div>
                      <div className="absolute bottom-4 left-4 text-white">
                        <div className="text-sm font-semibold">AI CMO Analytics</div>
                        <div className="text-xs opacity-90">Strategic insights & optimization</div>
                      </div>
                    </div>
              </div>
            </div>
