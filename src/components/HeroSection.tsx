      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-8 leading-tight">
            Flable is an AI-powered digital marketing team that
            <span className="text-blue-600 block md:inline"> runs and optimizes campaigns 24/7</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-8">
            <Link
              to="/book-demo"
              className="bg-blue-600 text-white px-12 py-5 rounded-xl text-xl font-bold hover:bg-blue-700 transform hover:scale-105 transition-all duration-200 shadow-xl flex items-center space-x-3 min-w-[280px] justify-center border-2 border-blue-600 hover:border-blue-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
            >
