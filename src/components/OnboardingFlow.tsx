  ...
  const steps = [
    {
      icon: Calendar,
      title: 'Book Demo',
      description: 'Schedule a consultation with our team to discuss your marketing goals and challenges.'
    },
    {
      icon: Settings,
      title: 'Onboarding',
      description: 'We connect your accounts, set up tracking, and configure your AI agents based on your needs.'
    },
    {
      icon: Rocket,
      title: 'Launch Campaign',
      description: 'Your AI marketing team takes over, launching optimized campaigns across all channels.'
    },
    {
      icon: TrendingUp,
      title: 'Optimize & Scale',
      description: 'Continuous optimization and scaling as your AI agents learn and improve performance.'
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            From initial consultation to full optimization, we make it easy to transform your marketing
          </p>
        </div>
        ...
        <div className="mt-16 max-w-2xl mx-auto">
          <div className="bg-gray-100 rounded-xl p-8 text-center border-2 border-dashed border-gray-300">
            ...
            <p className="text-gray-500">
              See how Flable.ai transforms your marketing in real-time
            </p>
