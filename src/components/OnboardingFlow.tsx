      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 max-w-2xl mx-auto">
          <div className="bg-gray-100 rounded-xl p-8 text-center border-2 border-dashed border-gray-300">
            <Play className="h-16 w-16 text-gray-400 mx-auto mb-4" aria-hidden="true" />
            ...
            <button className="mt-4 bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors">Play Demo Video</button>
          </div>
        </div>
      </div>
    </section>
