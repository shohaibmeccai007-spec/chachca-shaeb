...
import { ExternalLink, Calendar, User, ArrowRight, BookOpen } from 'lucide-react';
  ...
  const linkedInArticles = [
    {
      ...
      excerpt: 'Exploring the transformative power of AI in direct-to-consumer marketing strategies and the future of automated customer acquisition.',
    ...
    },
    {
      ...
      excerpt: 'Deep dive into how MYOP achieved remarkable results using Flable AI\'s intelligent marketing automation platform.',
      author: 'Alex Kumar',
      date: '2024-01-10',
      readTime: '7 min read',
    ...
    },
    {
      ...
      excerpt: 'Understanding the shift from traditional marketing teams to AI-powered marketing leadership and its impact on business growth.',
      author: 'Flable AI Team',
      date: '2024-01-05',
      readTime: '6 min read',
    ...
    },
    {
      ...
      excerpt: 'How Edureka transformed their student acquisition process using intelligent marketing automation and achieved unprecedented results.',
      author: 'Priya Sharma',
      date: '2024-01-01',
      readTime: '8 min read',
