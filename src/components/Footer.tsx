        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center space-x-3 mb-4">
              <img src="/logo.svg" alt="Flable.ai logo" className="h-8 w-auto" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><span className="text-gray-300">Safe Data Handling</span></li>
            </ul>
          </div>
        </div>
